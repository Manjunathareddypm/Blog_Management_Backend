...
exports.register = exports.login = exports.getEmailOfCurentUser = exports.getAllUsers = void 0;
...
var getEmailOfCurentUser = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return UserService.getEmailOfCurentUser(req.body);
        case 3:
          data = _context2.sent;
          res.status(_httpStatusCodes["default"].OK).json({
            code: _httpStatusCodes["default"].OK,
  ...
  return function getEmailOfCurentUser(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
exports.getEmailOfCurentUser = getEmailOfCurentUser;
